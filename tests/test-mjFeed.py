...
def test():
	...
	loader = MjFeedLoader()
	loader.go()
	# ret = loader.getMainItems(rangeOverride=1)
	# print(ret)
	...
	# cur = cl.conn.cursor()
	# ret = cur.execute("SELECT dbId, downloadPath, fileName FROM MjMangaItems WHERE downloadPath IS NOT NULL;")
